...
class ProhibitScreen extends Component {
    constructor(props){
        super(props);
        this.state = ({
            data: [],
    ...
    _getdata() {
        ...
        let newcode = null;
        db.transaction((tx) => {
            tx.executeSql('select * from bien_bao as bb where bb.loai_xe = 1 ORDER BY ten_loi asc', [], (tx, results) => {
